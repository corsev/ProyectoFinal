...
def insertar_luchador_bbdd():
    conexion = conectar_bbdd()
    cursor = conexion.cursor()
    ql_insertar_datos = "INSERT INTO luchadores (nombre,apodo,peso,ratio,cara) VALUES (%s, %s, %s, %s, %s)"
    nombre = insertar_luchador()
    print (nombre)
...
def insertar_luchador():
    ...
    inserta = Label(ventana3, text="Crea un nuevo Luchador", bg="grey", fg="black", width="500", height="3")
    ...
    guardar = Button(ventana3, text="Guardar", width=30, height=2, bg="grey", command=lambda : insertar_luchador_tkinter([nombre_entrada.get(),
                                                                                                                          apodo_entrada.get(),
                                                                                                                          peso_entrada.get(),
                                                                                                                          ratio_entrada.get(),
                                                                                                                          cara_entrada.get()]))
